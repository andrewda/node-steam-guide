...
websites. Throughout this course, we'll learn how to create both through a
...
Before actually beginning to write your code, make sure you have theses
...
Once installed, we can begin writing the code necessary to login to Steam and
simulate the Steam client. First of all, let's create a new file and call it
`project1.js`. Inside this file, we'll write out the following code.
...
### "Cannot find module: steam-user"

If you get this error, you have most likely installed the `steam-user` module
incorrectly. Try typing `npm install steam-user` again.
